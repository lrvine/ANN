...
protected:
	...
	void inline allocateMemoryForTrainingData(); // allocate memory for training data
	...
	void inline optimizeNetworkParameter();// optimize the network parameter via training data
	int inline doOnePrediction( double * ); //calculate the probability of each choice and choose the greatest one as our prediction
